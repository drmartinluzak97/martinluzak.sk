...
export const metadata: Metadata = {
  title: "Blog",
  description: "Technical articles, practical insights, and thoughts where logic meets humanity. Exploring systems, IT support, and technology.",
  openGraph: {
    title: "Blog — Martin Lužák",
    description: "Technical articles, practical insights, and thoughts where logic meets humanity.",
    url: `${baseUrl}/blog`,
    type: "website",
    images: [
      {
