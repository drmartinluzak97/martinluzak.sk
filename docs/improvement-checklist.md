...
export default function sitemap(): MetadataRoute.Sitemap {
  const posts = blogPosts.map((post) => ({
    url: `https://martinluzak.dev/blog/${post.slug}`,
  ...
  return [
    ...
    {
      url: 'https://martinluzak.dev/blog',
      lastModified: new Date(),
      changeFrequency: 'weekly',
      priority: 0.9,
    },
...
<rss version="2.0">
  <channel>
    <title>Martin Lužák Blog</title>
    <link>https://martinluzak.dev/blog</link>
    ...
    <item>
      ...
      <link>https://martinluzak.dev/blog/${post.slug}</link>
