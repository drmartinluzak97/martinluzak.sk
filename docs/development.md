...
\`\`\`bash
# Clone repository
git clone https://github.com/martinluzak/code-forge.git
cd martin-luzak
...
export const metadata: Metadata = {
  title: 'About | Martin Lužák',
  description: 'About Martin Lužák and this digital laboratory',
}
...
- **GitHub Issues**: https://github.com/martinluzak/code-forge/issues
